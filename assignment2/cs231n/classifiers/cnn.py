...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        self.params["W1"] = np.random.normal(
            0, weight_scale, (num_filters, C, filter_height, filter_width)
        )
    ...
    def loss(self, X, y=None):
        ...
        out, affine_cache1 = affine_forward(out, W2, b2)
        out, relu_cache2 = relu_forward(out)
        scores, affine_cache2 = affine_forward(out, W3, b3)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dout = relu_backward(dout, relu_cache1)
